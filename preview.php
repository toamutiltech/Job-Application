...
<html>
   ...
   <link rel="stylesheet" href="css/style.css" type="text/css" />
    ...
    <body>
      ...
      <li class="active"><a href="preview.php" >PREVIEW</a></li> 
      </ul>
                </div>
            </div>
...
//job_id, reg_id, jname, `position, syear, eyear, jaddress,
 ...
 while ($result14 = mysqli_fetch_array($result2)) {  
 ...
 while ($result13 = mysqli_fetch_array($result3)) {  
 ...
 <?php
        ...
        ?>
        <p align="center" ><a href="refere.php" class="btn"><img src="img/back.jpg" alt="" /></a></p> 
        <form method="post" action="">
            ...
            <p><input type="button" value="Finish" onclick="getConfirmation();" /></p>
            </form>
